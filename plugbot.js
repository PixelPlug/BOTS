...
var rulesMsg = "1- Tempo Maximo para Musicas : 5Min. 2- Respeitar os administradores. . 3-Sem Flood/Spam no chat. 4-Não fique pedindo cargo. 5-Musicas Repetidas/Fora dos temas permitidos serão Puladas! 6- Não divulgar outras salas. 7- Falar apenas em BR/PT. "; 
var rulesMsg2 = " 1 - Maximum Time for Music: 5Min. 2 - Respect the administrators. 3-No Flood / Spam in chat. 4 - Do not be asking post. 5-Music repeated / Off the themes allowed will be skipped! 6- Do not divulg other rooms. 7- Speak only in BR / PT. ";
var rulesMsg3 = "Temas permitidos: Tudo Menos Porn* e Funk. / Allowed Themes: Everything But Porn and Funk. ";
var linksMsg = ["[OZ] Respeitem as Regras Para não ser chutados da sala! "];
var skipMsg = ["Por favor, não nos mande pular a música, nós decidimos se pulamos ou não :v: "];
var fansMsg = ["Ganhe seus fãs tocando músicas boas e interagindo com todos :) ."];
var wafflesMsg = ["Entrem no nosso grupo no facebook, lá voce ficará por dentro de tudo que rola na OZ : https://www.facebook.com/groups/PlugDjOsZikas/ "];
...
var backMsg = ["To de volta :)"];

var autoAwayMsg = ["Depois Volto (AUSENTE)"];
...
function displayUI() {
	...
	$('#side-right .sidebar-content').append(
			'<a title="Settings" style="color:#FFD700">Configurações:</a>'
		+	'<a id="plug-btn-woot" title="Ativar/Desativar Auto-Woot" style="color:' + colorWoot + '">AutoWoot</a>'
		+ 	'<a id="plug-btn-queue" title="Ativar/Desativer Auto-Queque" style="color:' + colorQueue + '">Auto Join</a>'
		+ 	'<a id="plug-btn-stream" title="Ativar/Desativar Stream" style="color:' + colorStream + '">Video Streaming</a>'
		+ 	'<a id="plug-btn-hidevideo" title="Esconder/Mostrar Video" style="color:' + colorVideo + '">Hide Video</a>'
		+	'<a title="Messages" style="color:#FFD700">Mensagens:</a>'
		+	'<a id="plug-btn-rules" title="Manda mensagem das Regras" style="color:#084B8A">Regras</a>'
		+	'<a id="plug-btn-face" title="Sends fb and forums links" style="color:#084B8A">Social Links</a>'
		+	'<a id="plug-btn-en" title="Manda Mensagem de apenas Ingles" style="color:#084B8A">English Only</a>'
		+	'<a id="plug-btn-fans" title="Manda Mensagem de Fans" style="color:#084B8A">No Fans</a>'
		+	'<a id="plug-btn-noskip" title="Manda mensagem de NoSkip" style="color:#084B8A">No Skip</a>'
		+	'<a id="plug-btn-waffles" title="Manda Link do Grupo OZ" style="color:#084B8A">Grupo OZ</a>'
		+	'<a title="Mudar Seu Status" style="color:#FFD700">Status:</a>'
		+	'<a id="plug-btn-sleeping" title="Manda Mensagem De Ir Dormir e coloca status Adormecido" style="color:#5F04B4">Adormecido</a>'
		+	'<a id="plug-btn-working" title="Manda Mensagem de Trabalhar e coloca status Ocupado" style="color:#5F04B4">Ocupado</a>'
		+	'<a id="plug-btn-afk" title="Manda Mensagem de Ausente e coloca status Ausente" style="color:#5F04B4">Ausente</a>'
		+	'<a id="plug-btn-back" title="Manda Mensagem De Disponivel e coloca status Disponivel" style="color:#5F04B4">Disponivel</a>'
		+	'<a title="Moderação da Sala" style="color:#FFD700">Moderação:</a>'
		+	'<a id="plug-btn-skip" title="Pula o Dj Atual" style="color:#E90E82">Pular</a>'
		+	'<a id="plug-btn-lock" title="Trava a Cabine" style="color:#E90E82">Travar</a>'
		+	'<a id="plug-btn-unlock" title="Destrava a Cabine" style="color:#E90E82">Destravar</a>'
		+	'<a id="plug-btn-lockskip" title="Trava Cabine, Pula o DJ e Destrava a cabine" style="color:#E90E82">Travar e Pular</a>'
    );
}
